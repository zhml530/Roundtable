...
Rooms let multiple bots and people share context. Use a room when several specialists need the same brief or should hand work to one another. For structured work, the Coordinator turns the goal into a DAG, assigns focused tasks, and summarizes the result.
